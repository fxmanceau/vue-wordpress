...
export default {
  ...
  mounted()
  {
    ...
    this.dataViz = [...document.querySelectorAll('.data-visualization')]
    this.dataTexts = [...document.querySelectorAll('.text-data-enhancement')]
    this.detectMobile()
    ...
    this.visibileObject(this.dataViz)
    this.visibileObject(this.dataTexts)
